...
module AjaxHelper
  ...
  def link_to_with_callbacks name, options={}, html_options={}
    ...
    # Replacing remote_function and instead using the form_callback_javascript to handle the callbacks is straight-forward, and can be used the exactly as in
