...
#        end
        ...
        unless search_query.blank?
          ...
          unless search_results.blank?
            ...
            rest_method_ids_search_query = BioCatalogue::Search::Results::get_item_ids(search_results, "rest_methods")
          end
      ...
      def self.get_filters_for_tags_by_service_models(model_names, limit=nil, http_cycle=nil, search_query=nil)
        ...
        unless search_query.blank?
          ...
          unless search_results.blank?
            ...
            search_rest_method_ids = BioCatalogue::Search::Results::get_item_ids(search_results, 'rest_methods')
          end
        end
